    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger render={<Button className="rounded-xl font-semibold shadow-md shadow-slate-500/20" />}>
        ...
        <DialogContent className="sm:max-w-sm rounded-2xl">
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="flex gap-3">
              ...
              <Button className="flex-1 rounded-xl font-semibold shadow-md shadow-slate-500/20" onClick={() => {
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="p-16 text-center text-muted-foreground">
              <div className="h-14 w-14 mx-auto rounded-full bg-muted flex items-center justify-center text-muted-foreground mb-4">
