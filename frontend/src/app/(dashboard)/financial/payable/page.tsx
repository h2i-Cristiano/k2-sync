...
export default function PayablePage() {
  ...
  const [form, setForm] = useState({ description: "", amount: "", due_date: "", category: "Outros", notes: "" })
  ...
  const handleSave = async (id?: string) => {
    ...
    if (id) {
      ...
      const { error } = await supabase.from("financial_entries").insert({ ...form, amount, notes: form.notes || null, type: "payable", tenant_id: tenantId })
    ...
    setEditing(null)
    setShowNew(false)
    setForm({ description: "", amount: "", due_date: "", category: "Outros", notes: "" })
    fetchData()
  }
